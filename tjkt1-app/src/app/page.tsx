  ...
  return (
    <>
      <nav className="flex items-center justify-between flex-wrap bg-white p-4">
        <div className={`w-full text-black text-center text-3xl ${university.className}`}>
          XITJKT1
        </div>
      </nav>
  ...
  return (
    <div className={`grid-cols-2 grow p-8 text-black ${gatau.className}`}>
      ...
      <div className={`flex mt-7 ${gatau.className}`}>
        Lorem ipsum dolor sit, amet consectetur adipisicing elite. Perspiciatis ex atque culpa, 
        error illo labore voluptas voluptate, quam suscipit quod consequuntur, maiores 
        consequatur nihil similique eaque porro doloribus? Veritatis, voluptates.
      </div>
    </div>
  );
};
...
const Footer = () => {
  return (
    <footer className="bg-white p-4 text-center">
      <p className={`text-black ${gatau.className}`}>© 2024 XITJKT1. All rights reserved.</p>
    </footer>
  );
};
